...
<div class="mx-auto mt-2 max-w-7xl px-2 md:mt-5 md:px-5">
		...
		<Carousel.Content>
			{#each carouselPics as pic (pic)}
				<Carousel.Item>
					...
					>
						<div
							class="absolute inset-0 bg-gradient-to-br from-black/20 to-black/80"
						></div>
						<div
							class="absolute right-0 bottom-0 z-10 mb-14 px-5 md:mb-20 md:px-10"
						>
							<h1
								class="mb-1 text-2xl font-bold text-white md:mb-3 md:text-6xl"
							>
								Goods and more delivered to your door
							</h1>
							<p class=" mb-2 text-sm md:mb-5 md:text-lg">
								Discover, explore, and enjoy on-demand delivery from this store
								and more. Shop now and get access to a wide range of products,
								including electronics, fashion, home goods, and much more.
							</p>
						</div>
					</div>
				</Carousel.Item>
	...
	<section class="mt-20">
		...
		<p class="text-muted-foreground mt-2 text-sm md:mt-3 md:text-base">
			With our fast and reliable delivery service, you can have your favorite
			items delivered right to your doorstep. Start shopping today and
